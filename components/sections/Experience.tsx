    ...
    <section id="experience" className="py-24 bg-[#fdf6f0]">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="absolute left-3 top-0 bottom-0 w-px bg-pink-200 md:hidden" />
            ...
            {timeline.map((item) => (
              <div key={item.id}>
                ...
                <div className="flex items-start gap-3 md:hidden pl-8 relative">
                  <div className="absolute left-[9px] top-4 w-2.5 h-2.5 rounded-full bg-gradient-to-br from-pink-400 to-purple-400 ring-2 ring-white flex-shrink-0" />
                ...
                {/* DESKTOP */}
                <div
                  className={`hidden md:flex items-start gap-6 ${
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-1 w-16 flex-shrink-0">
                    <div className="w-3 h-3 rounded-full bg-gradient-to-br from-pink-400 to-purple-400 mt-5 ring-2 ring-white" />
