...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-[#fdf6f0] dark:bg-[#1c1b29]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-3 mt-2">
              <a
                ...
                className="flex items-center gap-3 bg-white dark:bg-[#252336] rounded-xl px-4 py-3 shadow-sm border border-gray-100 dark:border-white/10 hover:border-pink-200 transition-colors group"
              >
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5" aria-label="Formulario de contacto">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-[#fdf6f0] dark:bg-[#252336] border rounded-xl px-4 py-2.5 text-sm text-gray-700 placeholder:text-gray-300 focus:outline-none transition-colors ${
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full bg-[#fdf6f0] dark:bg-[#252336] border rounded-xl px-4 py-2.5 text-sm text-gray-700 placeholder:text-gray-300 focus:outline-none transition-colors resize-none ${
